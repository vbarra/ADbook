...
class Base(BaseEstimator, TransformerMixin):
    ...
    def plot_eigenvalues(self,ax,type="absolute", figsize=None):
        ...
        if type == "absolute":
            ...
            ax.bar(np.arange(1, self.eig_[2].shape[0] + 1), self.eig_[2],
                    color="green", align="center")
            ax.set_xlabel("num")
            ax.set_ylabel("\%  cumulé de variance")
        ax.set_title(type)

    def mapping(self, ax,num_x_axis, num_y_axis, short_labels=True, figsize=None):
        ...
        for i in np.arange(0, self.col_coord_.shape[0]):
            ax.text(self.col_coord_[i, num_x_axis - 1],
                     ...
                     horizontalalignment="center", verticalalignment="center",
                     color="blue")
        ax.set_title("Plan factoriel "+str(num_x_axis)+"/"+str(num_y_axis))
    ...
    def mapping_row(self, ax,num_x_axis, num_y_axis, figsize=None):
        ...
        for i in np.arange(0, self.row_coord_.shape[0]):
            ax.text(self.row_coord_[i, num_x_axis - 1],
                     ...
                     horizontalalignment="center", verticalalignment="center",
                     color="red")
        ax.set_title("Plan factoriel "+str(num_x_axis)+"/"+str(num_y_axis)+" lignes")
        ax.set_xlabel("Dim " + str(num_x_axis) + " ("
                    + str(np.around(self.eig_[1, num_x_axis - 1], 2)) + "%)")
        ax.set_ylabel("Dim " + str(num_y_axis) + " ("
                    + str(np.around(self.eig_[1, num_y_axis - 1], 2)) + "%)")
    ...
    def mapping_col(self, ax,num_x_axis, num_y_axis, short_labels=True,
                    figsize=None):
        ...
        for i in np.arange(0, self.col_coord_.shape[0]):
            ax.text(self.col_coord_[i, num_x_axis - 1],
                     ...
                     horizontalalignment="center", verticalalignment="center",
                     color="blue")
        ax.set_title("Plan factoriel "+str(num_x_axis)+"/"+str(num_y_axis)+" colonnes")
        ax.set_xlabel("Dim " + str(num_x_axis) + " ("
                    + str(np.around(self.eig_[1, num_x_axis - 1], 2)) + "%)")
        ax.set_ylabel("Dim " + str(num_y_axis) + " ("
                    + str(np.around(self.eig_[1, num_y_axis - 1], 2)) + "%)")
    ...
    def plot_row_contrib(self, num_axis, nb_values=None, figsize=None):
        ...
        plt.barh(r, contribs_sorted, height=bar_width, color="green",
                 align="edge")
        plt.title("Contributions points lignes")
    ...
    def plot_col_contrib(self, num_axis, nb_values=None, short_labels=True,
        ...
        plt.barh(r, contribs_sorted, height=bar_width, color="green",
                 align="edge")
        plt.title("Contributions points colonnes")
        plt.xlabel("Contributions (%)")
        plt.ylabel("Colonnes")
    ...
    def plot_row_cos2(self, num_axis, nb_values=None, figsize=None):
        ...
        bar_width = 0.5
        plt.yticks([ri + bar_width / 2 for ri in r], labels)
        plt.barh(r, cos2_sorted, height=bar_width, color="green",
                 align="edge")
        plt.title("Cos2")
        plt.xlabel("Cos2")
        plt.ylabel("Lignes")
