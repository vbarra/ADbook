...
\begin{defin}{Variable qualitative}{}
...
\begin{itemize}
\item la variable qualitative nominale, si les modalités  ne peuvent pas être ordonnées
\item la variable qualitative ordinale, si les modalités peuvent être ordonnées
\end{itemize}
\end{defin}

\begin{defin}{Variable quantitative}{}
La variable est dite quantitative lorsque les modalités sont des valeurs numériques (scalaires ou vectorielles) :
\begin{itemize}
\item la variable est quantitative discrète si les modalités forment un ensemble dénombrable
\item la variable quantitative est continue si les modalités vivent dans un espace continu.
\end{itemize}
\end{defin}
...
Le tableau statistique d'une variable qualitative nominale peut être représenté par deux types de graphiques. Les effectifs sont représentés par un diagramme en tuyau d'orgue (figure \ref{Fig:barre}) et les fréquences par un diagramme en secteurs (figure \ref{Fig:pie}). Pour ce dernier, si le nombre de modalités devient trop important, la représentation perd de son intérêt.

\begin{figure}[hbtp!]
 \centering
 \hspace*{\stretch{1}}
 \subfigure[Diagramme en barre\label{Fig:barre}]{
 \includegraphics[width=.4\columnwidth]{figures/bar.png}}
 \hspace*{\stretch{2}}
 \subfigure[Diagramme en secteurs.\label{Fig:pie}]{
 \includegraphics[width=.4\columnwidth]{figures/pie.png}}
 \hspace*{\stretch{1}}
 \caption{Diagrammes pour les variables qualitatives nominales.}
\end{figure}
...
La répartition des valeurs de la variable peut être représentée par un diagramme en bâtonnets (figure \ref{Fig:batonnets}). Les fréquences cumulées  sont visualisées par la fonction de répartition de la variable (figure \ref{Fig:répartition}), définie par 
...
\begin{figure}[hbtp!]
 \centering
 \hspace*{\stretch{1}}
 \subfigure[Diagramme en bâtonnets\label{Fig:batonnets}]{
 \includegraphics[width=.4\columnwidth]{figures/batonnets.png}}
 \hspace*{\stretch{2}}
 \subfigure[Approximation polygonale de la fonction de répartition.\label{Fig:répartition}]{
 \includegraphics[width=.4\columnwidth]{figures/repartition.png}}
 \hspace*{\stretch{1}}
 \caption{Diagrammes pour les variables quantitatives discrètes.}
\end{figure}
...
\begin{itemize}
\item $J=1+3.3log_{10}(n)$ (règle de Sturge)
\item $J=2.5\sqrt[4\,]{n}$ (règle de Yule)
\end{itemize}
